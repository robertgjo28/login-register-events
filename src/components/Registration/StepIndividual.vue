    ...
    <div class="row scrollable" v-if="activePhase === 1">
      ...
      <div class="col-10 m-auto pt-5">
        <div class="row d-flex justify-content-center align-items-center m-0">
          <div class="col-12 text-start no-padding ms-5">
            <h3 class="pb-2">Register individual account!</h3>
            <p class="paragraph-shock">
...
export default {
  ...
  methods: {
    ...
    async getInfoFromSec() {
      ...
      try {
        await this.$store.dispatch("submitData", this.values);
